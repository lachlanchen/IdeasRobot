...
- [نظرة معمارية](../references/ARCHITECTURE.md) — المحولات الخلفية، صيغ الرسائل، تدفق الواجهة.
- [ملاحظات SDK الخاصة بـ Wheeltec](../references/SDK_NOTES.md) — بناء حزم المصنع على لينكس/راسبيري باي وربطها مع بايثون.
